...
export default function App() {
  ...
  function getBalance() {
    ...
    web3.eth
      .getBalance("0x8A984BA6386ea53Dd988f2BFd2Fff83EB1188D92")
      .then((balance) => {
        console.log(
          "Account 0x8A984BA6386ea53Dd988f2BFd2Fff83EB1188D92 balance",
          balance
        );
  ...
  function getName() {
    ...
    contract.methods
      .name()
      .call({ from: "0x8A984BA6386ea53Dd988f2BFd2Fff83EB1188D92" })
  ...
  async function sendTokens() {
    ...
    // Sender Address!!!!
    var account = "0x8A984BA6386ea53Dd988f2BFd2Fff83EB1188D92";
    var privateKey = "PRIVATE_KEY";
    const contract = new web3.eth.Contract(abi, token_address);
    let gas = await contract.methods
      .transfer(recipient, send_amount)
      .estimateGas({ from: "0x8A984BA6386ea53Dd988f2BFd2Fff83EB1188D92" });
